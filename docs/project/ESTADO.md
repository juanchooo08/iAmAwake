...
- Icono propio (ojo abierto sobre fondo de noche). La fuente
  `Resources/icon-source.png` la genero Gemini via OpenRouter;
  `swift Scripts/make-icon.swift` la recorta, la enmascara con la esquina de
